            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (SuccessfulSet)
                    {
                        ...
                        {
                            API.LSPDFRPlusFunctions.AddCountToStatistic(TrafficPolicerHandler.TrafficPolicerPluginName, "Custom pullover locations set");
                        }
        ...
        public static void mimicMe()
        {
            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (TrafficPolicerHandler.IsLSPDFRPlusRunning)
                    {
                        API.LSPDFRPlusFunctions.AddCountToStatistic(TrafficPolicerHandler.TrafficPolicerPluginName, "Vehicles Mimicked");
                    }
                    //Driving loop
                    while (true)
                    {
        ...
        public static void followMe()
        {
            ...
            GameFiber.StartNew(delegate
            {
                try
                {
                    ...
                    if (TrafficPolicerHandler.IsLSPDFRPlusRunning)
                    {
                        API.LSPDFRPlusFunctions.AddCountToStatistic(TrafficPolicerHandler.TrafficPolicerPluginName, "Vehicles made to follow you");
                    }
